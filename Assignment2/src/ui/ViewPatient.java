...
public class ViewPatient extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tablePatient.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Gender", "Date of Birth", "Person ID", "Address", "City", "State", "Zip", "Community", "Temperature", "Blood Pressure", " Pulse Rate", " Diagnosis"
            }
        ));
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tablePatient.getModel();
        Object[] selected_row = new Object[13];
        ...
        patientDirectory.addPatient(selected_row[0].toString(),house,
                ...
                Integer.parseInt(selected_row[3].toString()),encounter);
...
private void populateTable() {
        ...
        for(Patient patient : patientDirectory.getPatients()){
            ...
            data[9] = patient.getEncounter().getVitalSign().getTemp();
            data[10] = patient.getEncounter().getVitalSign().getBloodPressure();
            data[11] = patient.getEncounter().getVitalSign().getPulseRate();
            data[12] = patient.getEncounter().getDiagnosis();
